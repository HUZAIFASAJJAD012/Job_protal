...
export default function UserProfile() {
    ...
    const {id} = useParams();
     ...
     useEffect(() => {
        ...
        fetchProfile();
    }, [id]); // Added 'id' as a dependency to re-fetch if 'id' changes
    ...
    if (loading) {
        return <p className="text-yellow-600 text-xl font-semibold text-center"
                  style={{marginLeft: "center"}}>.........Loading........</p>
